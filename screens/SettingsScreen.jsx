...
import Navbar from '../assets/NavBar'; // Importa el componente Navbar
    ...
    <View style={[tw`flex-1`, theme === 'dark' ? tw`bg-gray-800` : tw`bg-white`]}>
      ...
      <ScrollView style={tw`flex-1`}>
        ...
        <View style={tw`p-4 flex-row justify-between items-center`}>
          <Text style={[tw`text-lg`, theme === 'dark' ? tw`text-white` : tw`text-black`]}>
            Tema oscuro
          </Text>
        ...
        {/* Cambiar idioma */}
        <View style={tw`p-4`}>
          <Text style={[tw`text-lg mb-4`, theme === 'dark' ? tw`text-white` : tw`text-black`]}>
            Cambiar idioma
          </Text>
          <TouchableOpacity
